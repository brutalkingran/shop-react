						...
						<div className="line-clamp-2 flex flex-row m-1">
							{!item ? (
								...
								<div className="flex gap-2 items-center">
									<button onClick={() => decreaseQuantity(product.id)} className="rounded p-1 cursor-pointer hover:text-white bg-palette-light-100 text-white hover:bg-palette-light-400 transition dark:bg-palette-dark-100 dark:hover:bg-palette-dark-200">-</button>
									<span>{item.quantity}</span>
									<button onClick={() => increaseQuantity(product.id)} className="rounded p-1 cursor-pointer hover:text-white bg-palette-light-100 text-white hover:bg-palette-light-200 transition dark:bg-palette-dark-100 dark:hover:bg-palette-dark-200">+</button>
									<button onClick={() => removeItem(product.id)} className="text-palette-light-400 rounded-full border-2 border-palette-light-400 p-1 hover:bg-palette-light-400 cursor-pointer hover:text-white transition"><AiOutlineDelete size={20}/></button>
								</div>
							)}
						</div>
					</div>
